...
export default function CommunityPage() {
    ...
    // Use store decisions if logged in (includes personal ones), 
    // otherwise use the public ones we just fetched
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#30363d] pb-8">
                ...
                <div className="flex gap-4 w-full md:w-auto">
                    <div className="relative w-full md:w-96 group">
                        ...
                        <Input
                            id="community-search"
                            placeholder="Search global traces..."
                            className="h-14 bg-white/5 border-white/10 pl-12 text-lg rounded-2xl focus:border-primary transition-all font-bold placeholder:text-gray-600"
                        />
                    </div>
                </div>
            </div>
