...
export default function GlobalError({
    ...
    return (
        <html>
            <body style={{ fontFamily: 'system-ui, sans-serif', backgroundColor: 'black', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', margin: 0 }}>
